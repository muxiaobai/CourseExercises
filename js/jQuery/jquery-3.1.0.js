...
//###########################################################
//###########################################################
//jQuery.fn  = jQuery.prototype 167-251
...
//###########################################################
// 336-604
//jQuery.extend 静态属性/方法
//expando isReady guid 静态属性
//ready()3949-4027
//isFunction() isArray() isWindow() isNumeric() isPlainObject() isEmptyObject() type()
//noop() globalEval camelCase()  
...
//[ "reject",   "fail",    jQuery.Callbacks( "once memory" ),jQuery.Callbacks( "once memory" ), 1, "rejected" ]
	...
	when: function( singleValue ) {
		...
		//一个或者没有参数时(能够执行Promise.resolve()方法的参数)
...
//Deferred延时对象3617-3983
//###########################################################
//###########################################################
//###########################################################
//###########################################################
//jQuery.ready() 3949-4027
...
//###########################################################
//###########################################################
//Data.prototype可以防止内存泄漏  4183-4510
//DOM元素和对象之间互相引用，会引发内存泄漏。
// var odiv=document.getElementById("div");
// var obj={};
// odiv.name=obj;
// obj.age=odiv;
//Data.prototype   cache()set() get() acess() remove() hasData()
//jQuery.extend    hasData() data() removeData()  _data()  _removeData()
//jQuery.fn.extend data() remove()
function Data() {
...
Data.prototype = {
	...
	set: function( owner, data, value ) {
		...
		//asd-sad-sdfds转驼峰为asdSadSdfds
		//字符串 两个参数data为key value为值
...
//data()数据操作Data.prototype 4183-4510
//###########################################################
//###########################################################
//###########################################################
//###########################################################
//###########################################################
//queue()队列管理 先进先出 存储函数 4476-4636 4520
//使用dataPriv Data对象
//jQuery.extend  queue()  dequeue() _queueHooks()
//jQuery.fn.extend queue()  dequeue() clearQueue() promise()
jQuery.extend( {
...
//#########################################################################
//css()  6570-6829
//jQuery.extend cssHooks  cssNumber cssProps style() css()
//jQuery.fn.extend css() 
jQuery.extend( {
...
//jQuery.fx Tween6781-7622
//#########################################################
//#########################################################
//#########################################################
//#########################################################
//support7616-7640 hooks解决差异
( function() {
	var input = document.createElement( "input" ),
...
// attr() 自有属性 7686-7780
//原生setAttribute() getAttribute()
//jQuery.fn.extend attr() remove()
//jQuery.extend attr() attrHooks removeAttr()
var boolHook,
...
//jQuery.fn.extend prop() removeProp() 
//jQuery.extend prop() propHooks propFix
...
//###########################################################
//class() 操作 7892-8064
//jQuery.fn.extend  addClass() removeClass() toggleClass() hasClass()
...
jQuery.fn.extend( {
	...
	addClass: function( value ) {
		...
		//value是String 空格分隔 数组 循环添加setAttribute
		if ( typeof value === "string" && value ) {
			...
			while ( ( elem = this[ i++ ] ) ) {
				...
				//cur是之前的class，如果cur中没有clazz返回-1，把clazz添加到cur中
				if ( cur ) {
					j = 0;
					...
					//新的cur和和之前的不一样，设置新值。
					//如果一样，则说明没有新添加class或者，加的class在之前cur中含有
	...
	toggleClass: function( value, stateVal ) {
		...
		//stateVal为true，执行addClass() 为false，执行removeClass()
		...
		return this.each( function() {
			...
			//没有value 只有stateVal ：false，删除，true，添加
...
//option select radio checkbox 四种表单需要兼容
...
//###########################################################
//###########################################################
//trigger() 操作 8260-8435
//jQuery.extend(jQuery.event ) trigger() simulate()
//jQuery.fn.extend(jQuery.event ) trigger() triggerHandler()
...
//###########################################################################
//ajax 8742-10006
//addToPrefiltersOrTransports()  inspectPrefiltersOrTransports()
//ajaxExtend() ajaxHandleResponses() ajaxConvert()
//jQuery.extend  ajaxSetup() ajaxPrefilter() ajaxTransport() ajax()  getJSON() getScript()
//jQuery.get jQuery.post  底层都是调用jQuery.ajax 
var
	r20 = /%20/g,
	rhash = /#.*$/,
	rts = /([?&])_=[^&]*/,
...
//包裹
//jQuery.fn.extend wrapAll() wrapInner() wrap() unwrap() 9562-9629
jQuery.fn.extend( {
...
//#########################################################
//#########################################################
//support createHTMLDocument9940-9950
...
//###########################################################
//###########################################################
//offset position offsetParent位置操作
...
//###########################################################
//###########################################################
//innerHeight, innerWidth, height, width, outerHeight and outerWidth
