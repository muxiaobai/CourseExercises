...
public static void main(String[] args) throws IOException {
	...
	ballimg.add(ImageIO.read(new File("src\\awt\\img\\huaji2.png")));
	ballimg.add(ImageIO.read(new File("src\\awt\\img\\huaji4.png")));
	ballimg.add(ImageIO.read(new File("src\\awt\\img\\huaji3.png")));
