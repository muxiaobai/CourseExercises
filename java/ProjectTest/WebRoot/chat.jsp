...
<script type="text/javascript" src="//cdn.bootcss.com/jquery/1.4.1/jquery.min.js"></script>  
<title>Comet Chat Demo</title>  
<script type="text/javascript">  
var server = 'http://10.1.48.121:8089/ChatComet?name=<%=request.getParameter("name")%>';  
...
<div class="grid_10">  
    ...
    <div>  
        ...
        <input type="text" id="message" size="40"  onkeydown="enter();"></input>  
