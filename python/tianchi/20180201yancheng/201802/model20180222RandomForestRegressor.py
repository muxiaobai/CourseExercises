...
print mean_absolute_error(val_y,predicted_forest_num)#93
print(mean_squared_error(val_y,predicted_forest_num))#16938
...
my_submission.to_csv('submission20180222.csv',index = False,header = False,columns = ['date','cnt'])
my_submission.to_csv('result20180222.txt',index=False,header=False,columns = ['date','cnt'],sep='\t')
'''
