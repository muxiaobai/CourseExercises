...
test_answer= pd.read_table('../answer_top_A_20180225.txt')

all_test = pd.concat((test_data, test_answer[['cnt']]), axis=1)
...
print "answer " 
print mean_absolute_error(all_test[['cnt']],gbdt.predict(all_test[predict_cons]))
print(mean_squared_error(all_test[['cnt']],gbdt.predict(all_test[predict_cons])))
